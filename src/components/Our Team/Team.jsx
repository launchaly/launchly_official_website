            ...
            <div className="bg-white rounded-3xl p-6 md:p-10 flex flex-col lg:flex-row items-center gap-10 shadow-md">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-#000 text-[15px] leading-relaxed">
                  <strong>Sadanand Kumar Yadav</strong> He completed his B.Tech
                  in Computer Science in 2024. He started his career in the IT
                  ...
                  ability to deliver quality work in demanding environments.
                  After gaining years of experience throughout his journey, he
                  decided to start his own business. Now, he is the{" "}
